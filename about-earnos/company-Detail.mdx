...
- $1M Pre-Seed Raise completed
- EarnOS UX Design commences
- Platform Technical Architecture commences
- Development commences
- Product Alpha completed
- First Creators join EarnOS growth program
- Private Beta commences
- First revenue committed from launch partners.
- Verification Engine expanded
- EarnOS Growth program exceeds 750M user reach
- Seed commences
- EarnOS Global Marketing Campaign commences
- Public Beta limited to 10,000 users.
- Activate Launch Partners and Launch Creators
- Public Launch of EarnOS
- New Verifications Added to Engine
- Self service Mission library launch
